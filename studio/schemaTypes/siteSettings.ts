export default {
	...
	fields: [
		...
		// Hero image has been moved to R2 (https://assets.spiritmediapublishing.com/artsbyjustin/hero-*.webp)
		// for 100 Club performance — same-origin as fonts, stable URL, HTTP/2 103 Early Hints compatible.
		// To change it, upload a new WebP at 640/960/1200 widths to the same R2 path.
		{
			name: 'logo',
			title: 'Logo',
			type: 'image',
